<template>
  <div>
    <div
      ...
      :style="{
        'background-image': `url(${require('@/assets/images/BackgroundImage.jpg')})`,
      }"
    >
...
import productButton from "../../UI/Button/productButton.vue";
import baseChip from "../../UI/Chips/baseChip.vue";
